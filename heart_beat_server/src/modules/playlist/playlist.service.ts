  ...
  async handleJournalCreation(mood_tracking: MoodTracking) {
    ...
    const response = await cohere.chat({
      ...
      messages: [
        {
          role: 'user',
          content: `Generate a name or phrase and color hex (without the #) for a playlist that is based on the following moods: ${mood_tracking.mood}, and try to keep the color selected more muted and varied in tone and shade, don't be too cliche.
