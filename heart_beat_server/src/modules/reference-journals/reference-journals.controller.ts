...
export class ReferenceJournalsController {
  constructor(private readonly referenceJournalsService: ReferenceJournalsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateReferenceJournalDto: UpdateReferenceJournalDto) {
